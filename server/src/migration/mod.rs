...
use sqlx::{migrate::{Migrate, Migration, MigrationSource, Migrator}, Database, Pool};
...
pub async fn migrate<D: Database>(pool: &Pool<D>, schema_builder: &(dyn SchemaBuilder + Send + Sync)) -> crate::Result<()>
    where D::Connection: Migrate
{

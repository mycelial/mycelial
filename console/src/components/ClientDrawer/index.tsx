  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <IconButton
            sx={{ color: "#05386B", paddingTop: 0, paddingBottom: 0 }}
            onClick={onClose}
          >
            <ChevronLeftIcon />
          </IconButton>
        ...
        >
          {showHelperText && (
            <Paper
              elevation={0}
              sx={{ border: "0.5px solid #9e9e9e", padding: 2 }}
            >
              <CloseButton
                onClick={() => setShowHelpterText(false)}
                color="#acacac"
              />
        ...
        <Box
          ...
          ml={5}
          pb={5}
          sx={{ fontSize: "0.9rem", fontWeight: "bold", color: "#05386B" }}
        >
          Clients
        </Box>
      </Box>
      ...
      >
                          ...
                          return (
                            ...
                            >
                              <Box sx={{ alignSelf: "flex-start" }}>
                                {section.destination && (
                                  <DataChip flowType="destination" short />
                                )}
                                {section.source && (
                                  <DataChip flowType="source" short />
                                )}
                              </Box>
                              <Box
                                sx={{
        ...
        <Box
          my={3}
          sx={{ color: "#acacac", textAlign: "center", width: "100%" }}
        >
          -- End --
        </Box>
      </Box>

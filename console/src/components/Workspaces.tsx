...
const Workspaces = () => {
  const { setWorkspaces, addWorkspace, workspaces } =
    useWorkspacesStore(selector);
  ...
  const createRows = (workspaces: Workspace[]) =>
    workspaces.map((workspace) =>
      createData(workspace.id, workspace.name, workspace.created_at),
    );
      ...
      {addNewWorkspace && (
        ...
        >
          ...
          <Button
            ...
            color="primary"
            onClick={
              formik.handleSubmit as unknown as MouseEventHandler<HTMLButtonElement>
            }
          >
